...
def hp_example_scenario():
    ...
    # Input data csv
    HEAT_LOAD_DATA = os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))), 'docs','code','examples', 'data', 'heatpump_data.csv')
    # configure the simulator
